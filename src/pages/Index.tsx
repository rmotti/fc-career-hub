...
import { mockSaves, type SaveData } from "@/data/mockData";
...
const Index = () => {
  ...
  const renderScreen = () => {
    switch (screen) {
      ...
      case "squad": return <SquadScreen players={activeSave.players} />;
      case "stats": return <StatsScreen save={activeSave} />;
      case "history": return <HistoryScreen save={activeSave} />;
      case "transfers": return <TransfersScreen save={activeSave} />;
